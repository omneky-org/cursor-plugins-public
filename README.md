...
This repository is the Cursor Marketplace listing only: plugin JSON that points at the hosted Omneky MCP. It does not contain the MCP server source.
...
An [Omneky](https://www.omneky.com) account. On first use, Cursor opens Omneky sign-in (OAuth) to link your workspace.
