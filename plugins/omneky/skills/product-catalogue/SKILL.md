...
| Full record (description, benefits, audience, media) | `get_product_details` (alias `fetch_product_details`) |
...
3. Confirm name, description, and at least one image with the user (`request_user_decision` if needed; alias `ask_user`).
