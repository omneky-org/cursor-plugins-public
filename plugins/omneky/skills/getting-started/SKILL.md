...
First-session and pre-launch checks only. Do not launch, generate, or mutate catalogue from this skill. Never invent a brand, channel, or budget.
...
| Image ad, product video, edit, resize | `creative-generation` |
